<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_status.aspx.cs" Inherits="PersonalInformationForm.WebForm15" %>
...
<body>
  <!--Menu Bar-->
    ...
    <form id="form1" runat="server">
         <div>
            ...
            <asp:Label ID="Label3" runat="server" CssClass="auto-style12" Font-Size="X-Large" ForeColor="#3333CC" Text="ACCOUNT STATUS"></asp:Label>
             ...
             <asp:Label ID="Label18" runat="server" CssClass="auto-style35" Text="VERIFICATION:"></asp:Label>
                  <asp:Button ID="btn_approve" runat="server" CssClass="auto-style43" OnClick="btn_approve_Click" Text="ACTIVATE" BackColor="#EA7E37" BorderStyle="Dotted" Font-Bold="True" Font-Size="Large" />
                  <asp:Button ID="btn_decline" runat="server" CssClass="auto-style44" OnClick="btn_decline_Click" Text="SUSPEND" BackColor="Red" BorderStyle="Dotted" Font-Bold="True" Font-Size="Large" />
             <br />
 ...
 <div class="footer-basic">
        <footer>
            ...
            <div class="social" style="width: 1104px; z-index: 1; height: 65px; position: absolute; top: 973px; left: 141px;"><a href="#" class="auto-style45" ><i class="icon ion-social-twitter" style="z-index: 1; position: absolute; top: -22px; left: 475px; width: 38px; height: 41px;"></i></a><a href="#" class="auto-style46" ><i class="icon ion-social-facebook" style="z-index: 1; position: absolute; top: -20px; left: 533px; width: 39px"></i></a>
