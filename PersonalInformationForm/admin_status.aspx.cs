...
namespace PersonalInformationForm
{
    public partial class WebForm15 : System.Web.UI.Page
    {
        ...
        protected void btn_decline_Click(object sender, EventArgs e)
        {
            try
            {
                string verify_status = "SUSPENDED";
                ...
                using (var conn = new SqlConnection(connectionString))
                {
                    ...
                    {
                        cmd.CommandType = CommandType.Text;
                        cmd.CommandText = "UPDATE CLIENT SET CLI_DATE_UPDATED = @get_date, CLI_STATUS = @verify_status WHERE CLI_ID = @GET_ID";
